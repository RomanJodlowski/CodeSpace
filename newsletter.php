...
if (isset($_POST['email'])) {
    ...
    if (empty($email)) {
        ...
        try {
            ...
            $mail->CharSet = 'UTF-8';
            $mail->setFrom('no-reply@edwatches.co.uk');
            $mail->addAddress($email);
            $mail->addReplyTo('office@edwatches.co.uk', 'Office');
	        ...
	        <body>
	          <h1>Hello!</h1>
	          <p>Download the newest: <a href="https://edwatches/news.pdf">Download</a>
	          </p>
	          <hr>
	          <p>Admin test:</p>
	          <p>Webflix</p>
	          <p>Unsubscribe: <a href="https://edwatches.co.uk/unsubscribe">UNSUB</a>
	          </p>
	        </body>
	        </html>
	    	';

            $mail->addAttachment('image/imgBrand.jpg');
