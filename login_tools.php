<?php # Function to load specified or default URL.
...
# Check password field.
    ...
    //check status
//    $status = "SELECT status FROM users WHERE email='$e'";
//$r = mysqli_query( $link, $status ) ;
//if ( mysqli_num_rows( $r ) > 0 ) {
//    while ($row = mysqli_fetch_array($r, MYSQLI_ASSOC)) {
//        if (empty($row['status'])) {
//            $errors[] = 'Your account will be activated within 2h!';
//        }
